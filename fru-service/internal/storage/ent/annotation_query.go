...
func (aq *AnnotationQuery) QueryResource() *ResourceQuery {
...
func (aq *AnnotationQuery) WithResource(opts ...func(*ResourceQuery)) *AnnotationQuery {
	query := (&ResourceClient{config: aq.config}).Query()
...
func (aq *AnnotationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Annotation, error) {
	...
	if query := aq.withResource; query != nil {
		if err := aq.loadResource(ctx, query, nodes, nil,
...
func (aq *AnnotationQuery) loadResource(ctx context.Context, query *ResourceQuery, nodes []*Annotation, init func(*Annotation), assign func(*Annotation, *Resource)) error {
