...
func (c *AnnotationClient) QueryResource(a *Annotation) *ResourceQuery {
...
func (c *LabelClient) QueryResource(l *Label) *ResourceQuery {
	query := (&ResourceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := l.ID
		step := sqlgraph.NewStep(
...
func (c *ResourceClient) QueryLabels(r *Resource) *LabelQuery {
...
func (c *ResourceClient) QueryAnnotations(r *Resource) *AnnotationQuery {
