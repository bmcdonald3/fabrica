	...
	for i := range columns {
		...
		case resource.FieldResourceVersion:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				r.ResourceVersion = value.String
			}
...
func (r *Resource) QueryLabels() *LabelQuery {
	return NewResourceClient(r.config).QueryLabels(r)
}

// QueryAnnotations queries the "annotations" edge of the Resource entity.
func (r *Resource) QueryAnnotations() *AnnotationQuery {
	return NewResourceClient(r.config).QueryAnnotations(r)
}
...
func (r *Resource) String() string {
	...
	builder.WriteString(r.APIVersion)
	builder.WriteString(", ")
	...
	builder.WriteString(r.ResourceVersion)
	builder.WriteString(", ")
