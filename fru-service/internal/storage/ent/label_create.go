...
func (lc *LabelCreate) SetKey(s string) *LabelCreate {
...
func (lc *LabelCreate) SetResourceID(id int) *LabelCreate {
	lc.mutation.SetResourceID(id)
	return lc
}

// SetResource sets the "resource" edge to the Resource entity.
func (lc *LabelCreate) SetResource(r *Resource) *LabelCreate {
	return lc.SetResourceID(r.ID)
}
...
func (lc *LabelCreate) check() error {
	...
	if len(lc.mutation.ResourceIDs()) == 0 {
...
func (lc *LabelCreate) createSpec() (*Label, *sqlgraph.CreateSpec) {
	...
	if nodes := lc.mutation.ResourceIDs(); len(nodes) > 0 {
