...
func (lq *LabelQuery) QueryResource() *ResourceQuery {
	query := (&ResourceClient{config: lq.config}).Query()
...
func (lq *LabelQuery) Clone() *LabelQuery {
	...
	return &LabelQuery{
		...
		withResource: lq.withResource.Clone(),
...
func (lq *LabelQuery) WithResource(opts ...func(*ResourceQuery)) *LabelQuery {
	query := (&ResourceClient{config: lq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	lq.withResource = query
	return lq
}
...
func (lq *LabelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Label, error) {
	...
	if query := lq.withResource; query != nil {
		if err := lq.loadResource(ctx, query, nodes, nil,
...
func (lq *LabelQuery) loadResource(ctx context.Context, query *ResourceQuery, nodes []*Label, init func(*Label), assign func(*Label, *Resource)) error {
