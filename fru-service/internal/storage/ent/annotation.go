	...
	for i := range columns {
		...
		case annotation.ForeignKeys[0]:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				a.resource_annotations = new(int)
				*a.resource_annotations = int(value.Int64)
			}
		default:
...
func (a *Annotation) QueryResource() *ResourceQuery {
	return NewAnnotationClient(a.config).QueryResource(a)
}
